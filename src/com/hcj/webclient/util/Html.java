...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    private static void startImg(SpannableStringBuilder text,
        ...
        String width_str = attributes.getValue("", "width");
        String height_str = attributes.getValue("", "height");
        int width = (width_str != null) ? Integer.parseInt(attributes.getValue("", "width")) : 0;
        int height = (height_str != null) ? Integer.parseInt(attributes.getValue("", "height")) : 0;
